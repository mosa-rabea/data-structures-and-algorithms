...
const addOne = (arr) => arr.map((each) => each + 1);
...
const addQuestion = (arr) => arr.map((each) => each + "?");

/* ------------------------------------------------------------------------------------------------
CHALLENGE 4

Write a function named forLoopTwoToThe that, given an array of integers as input, iterates over the array and returns a new array. The returned array should contain the result of raising 2 to the power of the original input each.
...
const forLoopTwoToThe = (arr) => arr.map((each) => Math.pow(2, each));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
------------------------------------------------------------------------------------------------ */
const mapTwoToThe = (arr) => arr.map((each) => Math.pow(2, each));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 7 - Stretch Goal

Write a function named charCode that, given an array of letters as an input, uses map to return a new array where each each is the result of the `charCodeAt` method on the original array each.
...
const charCode = (arr) => arr.map((each) => each.charCodeAt());
/* ------------------------------------------------------------------------------------------------
CHALLENGE 8 - Stretch Goal

Write a function that, given an array of numbers as input, uses map to return a new array where each each is either the string "even" or the string "odd", based on each value.

If any each in the array is not a number, the resulting array should have the string "N/A" in its place.
...
Here is an example of a single array each: { name: 'speed', total: 35 }
------------------------------------------------------------------------------------------------ */
