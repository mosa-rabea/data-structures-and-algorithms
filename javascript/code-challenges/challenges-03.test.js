...
const typeNum = (arr) => arr.filter((each) =>( (!isNaN(each))));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const containsAnd = arr => arr.filter((each) => each.includes('and'));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const oddValues = arr => arr.filter( (each) => each % 2 != 0 );
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter( each => !forbiddenValues.includes(each) );
...
const getBaseStatGreaterThan = (arr, minBaseStat) => arr.filter( (each) => each.baseStat > minBaseStat );
/* ------------------------------------------------------------------------------------------------
